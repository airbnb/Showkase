# Showkase
![Showkase Version](https://img.shields.io/badge/Showkase-1.0.0--alpha10-brightgreen) ![Compatible with Compose](https://img.shields.io/badge/Compatible%20with%20Compose-1.0.0--beta05-brightgreen)
...
```kotlin
implementation "com.airbnb.android:showkase:1.0.0-alpha10"
kapt "com.airbnb.android:showkase-processor:1.0.0-alpha10"
```
