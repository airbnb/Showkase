# Showkase
![Showkase Version](https://img.shields.io/badge/Showkase-1.0.0--beta11-brightgreen) ![Compatible with Compose](https://img.shields.io/badge/Compatible%20with%20Compose-1.0.4-brightgreen)
...
kapt "com.airbnb.android:showkase-processor:1.0.0-beta11"
```

#### If you are using ksp
```kotlin
implementation "com.airbnb.android:showkase:1.0.0-beta11"
ksp "com.airbnb.android:showkase-processor:1.0.0-beta11"
```
