# Showkase
![Showkase Version](https://img.shields.io/badge/Showkase-1.0.0--alpha05-brightgreen)
...
```kotlin
implementation "com.airbnb.android:showkase:1.0.0-alpha05"
kapt "com.airbnb.android:showkase-processor:1.0.0-alpha05"
```
