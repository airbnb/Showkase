...
import com.vinaygaba.showkase.processor.ShowkaseProcessor.Companion.CODEGEN_PACKAGE_NAME
        ...
        showkaseMetadataList.forEachIndexed { index, showkaseMetadata ->
            val methodName = when {
                showkaseMetadata.enclosingClass == null -> showkaseMetadata.methodName
                    ...
                    val enclosingClassName = typeUtil.asElement(showkaseMetadata.enclosingClass).simpleName
            ...
            val annotation = AnnotationSpec.builder(ShowkaseCodegenMetadata::class)
                ...
                .addMember("showkaseComposableWidthDp = %L", showkaseMetadata.showkaseComponentWidthDp)
                .addMember("showkaseComposableHeightDp = %L", showkaseMetadata.showkaseComponentHeightDp)
