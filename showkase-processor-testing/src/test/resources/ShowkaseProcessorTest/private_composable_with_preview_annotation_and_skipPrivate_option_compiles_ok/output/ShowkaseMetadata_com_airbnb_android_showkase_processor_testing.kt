...
public class ShowkaseMetadata_com_airbnb_android_showkase_processor_testing {
  ...
  @ShowkaseCodegenMetadata(
    ...
    insideWrapperClass = false,
    showkaseKDoc = "",
    generatedPropertyName = "comairbnbandroidshowkaseprocessortestingTestComposable3group3name3",
    showkaseMetadataType = "COMPONENT",
    isDefaultStyle = false,
  )
  public fun comairbnbandroidshowkaseprocessortestingTestComposable3group3name3(): Unit {
  }
}
