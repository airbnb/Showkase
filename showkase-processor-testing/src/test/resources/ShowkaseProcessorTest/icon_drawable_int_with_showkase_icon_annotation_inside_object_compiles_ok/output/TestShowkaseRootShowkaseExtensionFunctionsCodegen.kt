...
public fun Showkase.getBrowserIntent(context: Context): Intent {
    ...
    intent.putExtra("SHOWKASE_ROOT_MODULE",
        "ShowkaseProcessorTest.icon_image_vector_with_showkase_icon_annotation_inside_object_compiles_ok.input.TestShowkaseRoot")
    return intent
}
...
public fun Showkase.getMetadata(): ShowkaseElementsMetadata {
    try {
      val showkaseComponentProvider =
          Class.forName("ShowkaseProcessorTest.icon_image_vector_with_showkase_icon_annotation_inside_object_compiles_ok.input.TestShowkaseRootCodegen").newInstance()
          as ShowkaseProvider
