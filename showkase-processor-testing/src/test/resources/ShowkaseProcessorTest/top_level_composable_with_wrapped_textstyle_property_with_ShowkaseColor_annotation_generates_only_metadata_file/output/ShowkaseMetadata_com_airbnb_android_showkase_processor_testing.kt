...
public class ShowkaseMetadata_com_airbnb_android_showkase_processor_testing {
  ...
  @ShowkaseCodegenMetadata(
    ...
    generatedPropertyName =
        "comairbnbandroidshowkaseprocessortestingWrapperClasstitletypographyname",
    enclosingClass = [WrapperClass::class],
    showkaseMetadataType = "TYPOGRAPHY",
  )
  public fun comairbnbandroidshowkaseprocessortestingWrapperClasstitletypographyname(): Unit {
  }
}
